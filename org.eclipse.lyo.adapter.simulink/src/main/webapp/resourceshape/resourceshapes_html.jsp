...
<title>Simulink OSLC Adapter: Resource Shapes</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Resource Shapes</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Resource Shapes </span>Simulink</h1>
		<br>
