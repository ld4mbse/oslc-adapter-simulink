...
<title>Simulink OSLC Adapter: Simulink Blocks</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Simulink Blocks</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Simulink Blocks </span><%= modelName %></h1>
		<br>
