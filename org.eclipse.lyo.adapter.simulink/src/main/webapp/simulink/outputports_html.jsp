...
<title>Simulink OSLC Adapter: Simulink Output Ports</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Simulink Output Ports</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Simulink Output Ports </span><%= modelName %></h1>
		<br>
