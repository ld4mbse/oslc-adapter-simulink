...
<title>Simulink OSLC Adapter: Simulink Input Ports</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Simulink Input Ports</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Simulink Input Ports </span><%= modelName %></h1>
		<br>
