...
<title>Simulink OSLC Adapter: Simulink Parameters</title>
...
<body onload="">
	...
	<!-- header -->
	<p id="title">Simulink OSLC Adapter: Simulink Parameters</p>
	...
	<div id="main-body">
		...
		<h1><span id="metainfo">Simulink Parameters </span><%= modelName %></h1>
		<br>
